...
> 你在這裡:**🐣 手冊** → [0 診斷](/workflow/0-diagnose/) → [1 驗證](/workflow/1-validate/) → [2 基線](/workflow/2-baseline/) → [3 特徵](/workflow/3-features/) → [4–5 集成與交卷](/workflow/4-ensemble/)

> ⏱ 閱讀約 **18 分鐘** · 前置:會跑 Python + 一個 Kaggle 帳號 · **動手做**:跟著做完就有第一份提交
